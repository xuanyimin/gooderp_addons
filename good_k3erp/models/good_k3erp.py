...
class good_k3erp(models.Model):
    ...
    def exp_k3(self):
        ...
        workbook.save(u'销售发票.xls')
        self.closeConnection(conn)

    # 导出K3物料
    @api.multi
    def exp_k3_goods(self):
        ...
        i = j = 0
        good = []
        max_code = self.search_max_code(conn)[0]
        a,b = max_code. split('.')
        for key in colnames:
            worksheet.write(0,j,key)
            j += 1
